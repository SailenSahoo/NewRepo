...
const Table = () => {
  ...
  // Generate chart data for reportees
  const chartData2 = {
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: "BB/GHE Repo Count Per Managing Director",
      },
    },
  };
  ...
  return (
    <div>
      <h3 className="heading-table">
        Status Overview of Managing Directors and Their Reportees
      </h3>
